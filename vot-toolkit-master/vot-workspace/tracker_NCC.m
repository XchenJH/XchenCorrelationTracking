...
% error('Tracker not configured! Please edit the tracker_NCC.m file.'); 
% Remove this line after proper configuration
...
% tracker_command = '/home/paul/tracking/vot-toolkit-master/tracker/examples/matlab/';
tracker_command = generate_matlab_command('ncc', {'/home/paul/tracking/vot-toolkit-master/tracker/examples/native/'});
